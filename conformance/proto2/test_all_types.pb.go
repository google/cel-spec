...
func file_cel_expr_conformance_proto2_test_all_types_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_cel_expr_conformance_proto2_test_all_types_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_cel_expr_conformance_proto2_test_all_types_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_cel_expr_conformance_proto2_test_all_types_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_cel_expr_conformance_proto2_test_all_types_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_cel_expr_conformance_proto2_test_all_types_proto_msgTypes[167].Exporter = func(v any, i int) any {
