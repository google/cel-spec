...
type Bindings struct {
	...
	Values map[string]*Bindings_InputValue `protobuf:"bytes,1,rep,name=values,proto3" json:"values,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
func (x *Bindings) GetValues() map[string]*Bindings_InputValue {
	if x != nil {
		return x.Values
	}
	return nil
...
type Bindings_InputValue struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	//
	//	*Bindings_InputValue_Value
	//	*Bindings_InputValue_Expr
	Kind isBindings_InputValue_Kind `protobuf_oneof:"kind"`
}

func (x *Bindings_InputValue) Reset() {
	*x = Bindings_InputValue{}
	if protoimpl.UnsafeEnabled {
...
func (x *Bindings_InputValue) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Bindings_InputValue) ProtoMessage() {}

func (x *Bindings_InputValue) ProtoReflect() protoreflect.Message {
	mi := &file_cel_expr_conformance_test_suite_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Bindings_InputValue.ProtoReflect.Descriptor instead.
func (*Bindings_InputValue) Descriptor() ([]byte, []int) {
	return file_cel_expr_conformance_test_suite_proto_rawDescGZIP(), []int{3, 0}
}

func (m *Bindings_InputValue) GetKind() isBindings_InputValue_Kind {
	if m != nil {
		return m.Kind
	}
	return nil
...
func (x *Bindings_InputValue) GetValue() *expr.Value {
	if x, ok := x.GetKind().(*Bindings_InputValue_Value); ok {
		return x.Value
	}
	return nil
}

func (x *Bindings_InputValue) GetExpr() string {
	if x, ok := x.GetKind().(*Bindings_InputValue_Expr); ok {
		return x.Expr
	}
	return ""
}

type isBindings_InputValue_Kind interface {
	isBindings_InputValue_Kind()
}

type Bindings_InputValue_Value struct {
	Value *expr.Value `protobuf:"bytes,1,opt,name=value,proto3,oneof"`
}

type Bindings_InputValue_Expr struct {
	Expr string `protobuf:"bytes,2,opt,name=expr,proto3,oneof"`
}

func (*Bindings_InputValue_Value) isBindings_InputValue_Kind() {}

func (*Bindings_InputValue_Expr) isBindings_InputValue_Kind() {}
...
var file_cel_expr_conformance_test_suite_proto_rawDesc = []byte{
	...
	0x73, 0x75, 0x6c, 0x74, 0x5f, 0x6b, 0x69, 0x6e, 0x64, 0x22, 0x93, 0x02, 0x0a, 0x08, 0x42, 0x69,
	...
	,
...
var file_cel_expr_conformance_test_suite_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_cel_expr_conformance_test_suite_proto_goTypes = []any{
	...
	(*Bindings_InputValue)(nil),     // 4: cel.expr.conformance.test.Bindings.InputValue
	nil,                             // 5: cel.expr.conformance.test.Bindings.ValuesEntry
	(*conformance.Environment)(nil), // 6: cel.expr.conformance.Environment
...
var file_cel_expr_conformance_test_suite_proto_depIdxs = []int32{
	...
	6,  // 2: cel.expr.conformance.test.TestCase.env:type_name -> cel.expr.conformance.Environment
	3,  // 3: cel.expr.conformance.test.TestCase.bindings:type_name -> cel.expr.conformance.test.Bindings
	7,  // 4: cel.expr.conformance.test.TestCase.context_message:type_name -> google.protobuf.Any
	8,  // 5: cel.expr.conformance.test.TestCase.result_value:type_name -> cel.expr.Value
	9,  // 6: cel.expr.conformance.test.TestCase.eval_error:type_name -> cel.expr.ErrorSet
	10, // 7: cel.expr.conformance.test.TestCase.unknown:type_name -> cel.expr.UnknownSet
	11, // 8: cel.expr.conformance.test.TestCase.deduced_type:type_name -> cel.expr.Type
	5,  // 9: cel.expr.conformance.test.Bindings.values:type_name -> cel.expr.conformance.test.Bindings.ValuesEntry
	8,  // 10: cel.expr.conformance.test.Bindings.InputValue.value:type_name -> cel.expr.Value
	4,  // 11: cel.expr.conformance.test.Bindings.ValuesEntry.value:type_name -> cel.expr.conformance.test.Bindings.InputValue
...
func file_cel_expr_conformance_test_suite_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_cel_expr_conformance_test_suite_proto_msgTypes[4].Exporter = func(v any, i int) any {
			switch v := v.(*Bindings_InputValue); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_cel_expr_conformance_test_suite_proto_msgTypes[4].OneofWrappers = []any{
		(*Bindings_InputValue_Value)(nil),
		(*Bindings_InputValue_Expr)(nil),
	}
	type x struct{}
