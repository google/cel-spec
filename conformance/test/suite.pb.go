...
type TestCase struct {
	...
	// Types that are valid to be assigned to InputKind:
	//
	//	*TestCase_Bindings
...
func (x *TestCase) GetInputKind() isTestCase_InputKind {
	if x != nil {
		return x.InputKind
	}
	return nil
...
func (x *TestCase) GetBindings() *Bindings {
	if x != nil {
		if x, ok := x.InputKind.(*TestCase_Bindings); ok {
			return x.Bindings
		}
	}
	return nil
...
func (x *TestCase) GetContextMessage() *anypb.Any {
	if x != nil {
		if x, ok := x.InputKind.(*TestCase_ContextMessage); ok {
...
func (x *TestCase) GetContextExpr() string {
	if x != nil {
		if x, ok := x.InputKind.(*TestCase_ContextExpr); ok {
...
func (x *TestCase) GetResultKind() isTestCase_ResultKind {
	if x != nil {
		return x.ResultKind
	}
	return nil
...
func (x *TestCase) GetResultValue() *expr.Value {
	if x != nil {
		if x, ok := x.ResultKind.(*TestCase_ResultValue); ok {
...
func (x *TestCase) GetResultExpr() string {
	if x != nil {
		if x, ok := x.ResultKind.(*TestCase_ResultExpr); ok {
			return x.ResultExpr
		}
	}
	return ""
...
func (x *TestCase) GetEvalError() *expr.ErrorSet {
	if x != nil {
		if x, ok := x.ResultKind.(*TestCase_EvalError); ok {
			return x.EvalError
		}
	}
	return nil
...
func (x *TestCase) GetUnknown() *expr.UnknownSet {
	if x != nil {
		if x, ok := x.ResultKind.(*TestCase_Unknown); ok {
			return x.Unknown
		}
	}
	return nil
...
type Bindings struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Values        map[string]*expr.Value `protobuf:"bytes,1,rep,name=values,proto3" json:"values,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
