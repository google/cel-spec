...
const file_cel_expr_conformance_test_suite_proto_rawDesc = "" +
	"\n" +
	...
	"\bsections\x18\x03 \x03(\v2&.cel.expr.conformance.test.TestSectionR\bsections\"~\n" +
	"\vTestSection\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12 \n" +
	"\vdescription\x18\x02 \x01(\tR\vdescription\x129\n" +
	"\x05tests\x18\x03 \x03(\v2#.cel.expr.conformance.test.TestCaseR\x05tests\"\x95\x04\n" +
	"\bTestCase\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12 \n" +
	"\vdescription\x18\x02 \x01(\tR\vdescription\x12\x12\n" +
	"\x04expr\x18\x03 \x01(\tR\x04expr\x123\n" +
	"\x03env\x18\x04 \x01(\v2!.cel.expr.conformance.EnvironmentR\x03env\x12D\n" +
	"\x05input\x18\x05 \x03(\v2..cel.expr.conformance.test.TestCase.InputEntryR\x05input\x12L\n" +
	"\rinput_context\x18\x06 \x01(\v2'.cel.expr.conformance.test.InputContextR\finputContext\x12=\n" +
	"\x06output\x18\a \x01(\v2%.cel.expr.conformance.test.TestOutputR\x06output\x121\n" +
	"\fdeduced_type\x18\b \x01(\v2\x0e.cel.expr.TypeR\vdeducedType\x12#\n" +
	"\rdisable_check\x18\t \x01(\bR\fdisableCheck\x1a_\n" +
	"\n" +
	"InputEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12;\n" +
	"\x05value\x18\x02 \x01(\v2%.cel.expr.conformance.test.InputValueR\x05value:\x028\x01\"\x8a\x01\n" +
	"\fInputContext\x12?\n" +
	"\x0fcontext_message\x18\x01 \x01(\v2\x14.google.protobuf.AnyH\x00R\x0econtextMessage\x12#\n" +
	"\fcontext_expr\x18\x02 \x01(\tH\x00R\vcontextExprB\x14\n" +
	"\x12input_context_kind\"S\n" +
	"\n" +
	"InputValue\x12'\n" +
	"\x05value\x18\x01 \x01(\v2\x0f.cel.expr.ValueH\x00R\x05value\x12\x14\n" +
	"\x04expr\x18\x02 \x01(\tH\x00R\x04exprB\x06\n" +
	"\x04kind\"\xdb\x01\n" +
	"\n" +
	"TestOutput\x124\n" +
	"\fresult_value\x18\b \x01(\v2\x0f.cel.expr.ValueH\x00R\vresultValue\x12!\n" +
	"\vresult_expr\x18\t \x01(\tH\x00R\n" +
	"resultExpr\x123\n" +
	"\n" +
	"eval_error\x18\n" +
	" \x01(\v2\x12.cel.expr.ErrorSetH\x00R\tevalError\x120\n" +
	"\aunknown\x18\v \x01(\v2\x14.cel.expr.UnknownSetH\x00R\aunknownB\r\n" +
	"\vresult_kindBO\n" +
	"\x1ddev.cel.expr.conformance.testB\n" +
	"SuiteProtoP\x01Z\x1dcel.dev/expr/conformance/test\xf8\x01\x01b\x06proto3"

var (
	file_cel_expr_conformance_test_suite_proto_rawDescOnce sync.Once
	file_cel_expr_conformance_test_suite_proto_rawDescData []byte
)
...
func file_cel_expr_conformance_test_suite_proto_rawDescGZIP() []byte {
	file_cel_expr_conformance_test_suite_proto_rawDescOnce.Do(func() {
		file_cel_expr_conformance_test_suite_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_cel_expr_conformance_test_suite_proto_rawDesc), len(file_cel_expr_conformance_test_suite_proto_rawDesc)))
	})
...
func file_cel_expr_conformance_test_suite_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_cel_expr_conformance_test_suite_proto_rawDesc), len(file_cel_expr_conformance_test_suite_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   7,
			NumExtensions: 0,
			NumServices:   0,
